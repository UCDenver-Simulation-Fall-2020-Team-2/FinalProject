...
def species_strength_intel_time(frame):
    ...
    fig, ax = plt.subplots()
    ax.plot(x, evil_intelligence, 'r-', label='Evil Average Intelligence')
    ax.plot(x, evil_strength, 'm-', label='Evil Average Strength')

    ax.plot(x, neutral_intelligence, 'r--', label='Neutral Average Intelligence')
    ax.plot(x, neutral_strength, 'm--', label='Neutral Average Strength')
    ax.grid()
    ax.legend()
    ax.set(xlabel='Time Ticks', ylabel='Strength & Intelligence', title='Strength & Intelligence/Time')
    plt.show()
